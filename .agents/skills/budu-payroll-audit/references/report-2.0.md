...
PDF is portrait, single-column and mobile-readable. Use the canonical budu wordmark asset on the cover, compact cards rather than wide tables, correct embedded/system CJK fonts, restrained budu Pink, status colors and explicit page breaks. Render to images and inspect every page before delivery.
