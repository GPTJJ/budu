...
export const en = {
  ...
  '按周': 'Weekly',
  '按月': 'Monthly',
  '今日经营': "Today's Operations",
  '当日经营': 'Daily Operations',
  '本周经营': 'This Week',
  '周经营': 'Weekly Operations',
  '本月经营': 'This Month',
  '较上周': 'vs last week',
  '较上月同日': 'vs same day last month',
  '商品销量': 'Product Sales',
  '营业趋势': 'Revenue Trend',
  '待办事项': 'Tasks',
  '待审批': 'Approvals',
  '库存预警': 'Stock Alerts',
  '门店待录入': 'Missing Entries',
  '异常事项': 'Exceptions',
  '最近动态': 'Recent Activity',
  '全部动态': 'All Activity',
  '待录入门店': 'Stores Missing Entry',
  '待办详情': 'Task Details',
  '今日待录入': 'Due Today',
  '今日门店均已完成录入': 'All stores completed today',
  '进入业绩录入': 'Open Store Entry',
  '暂无门店经营数据': 'No store data',
  '暂无最近动态': 'No recent activity',
  '暂无异常事项': 'No exceptions',
  '暂无趋势数据': 'No trend data',
  '动态加载失败，请稍后刷新': 'Could not load activity. Please refresh later.',
  '当前账号无管理待办': 'No management tasks for this account',
  '自然周 {start} 起 · 对比上一自然周': 'Week starting {start} · vs previous week',
  '{start} 起 · 按自然周营业收入排序': 'Week starting {start} · ranked by revenue',
  '{start} 起 · {store} 自然周趋势': 'Week starting {start} · {store} trend',
  '{start} 起 · {store} 按自然周': 'Week starting {start} · {store}',
  '周收入 ¥{inc} · {ord} 单': 'Weekly revenue ¥{inc} · {ord} orders',
  '{period} · {store} · 按销售额排序': '{period} · {store} · by sales',
  ...
  // 工资条板块（人员管理 → 工资条）
  '工资条': 'Payroll Slip',
  '发放工资条': 'Issue Payroll Slips',
  '待签收': 'Pending',
  '已签收': 'Confirmed',
  '全部员工工资条（按发放时间倒序）': 'All payroll slips (newest first)',
  '本人工资条记录 · 点击查看每日明细': 'My payroll slips · tap a row to view daily details',
  '待签收的工资条会持续在右上角铃铛提醒，确认签收后自动归档':
    'Unconfirmed slips keep alerting in the bell; they are archived once confirmed',
  '尚未发放过工资条': 'No payroll slips issued yet',
  '暂无工资条记录': 'No payroll slip records',
  '该状态下暂无记录': 'No records in this status',
  '点击右上角「发放工资条」按周期发放': 'Click "Issue Payroll Slips" to issue by period',
  '当前账号无权查看工资条': 'Your account cannot view payroll slips',
  '工资条仅对开发者、店长与店员开放': 'Payroll slips are only available to developer, managers and staff',
  '于': 'at',
  '签收': 'signed',
  '待本人签收': 'Awaiting your confirmation',
  '发放于': 'Issued at',
  '由 {name} 发放': 'Issued by {name}',
  // 审批中心（工资/报销审批）
  '审批中心': 'Approval Center',
  '工资与报销审批 · 提交 → 老板审批 → 抄送财务': 'Payroll & expense approvals · submit → boss review → CC finance',
  '待我审批': 'Pending My Approval',
  '我发起的': 'My Requests',
  '抄送我的': 'CC to Me',
  '全部审批': 'All Approvals',
  '新建申请': 'New Request',
  '当前账号无权使用审批中心': 'Your account cannot access the approval center',
  '审批': 'Approval',
  '暂无待我审批的申请': 'No requests awaiting your approval',
  '你还没有发起过申请': 'You have not submitted any requests',
  '暂无抄送我的记录': 'No CC records for you',
  '暂无审批记录': 'No approval records',
  '点击右上角「新建申请」发起工资或报销审批': 'Click "New Request" to start a payroll or expense approval',
  '工资合计': 'Total wage',
  '当日工资': 'Daily wage',
  '工时': 'Hours',
  '当日工时': 'Daily hours',
  ...
  '调整每日薪资': 'Adjust Daily Pay',
  '调整后金额将作为当天最终工资': 'The adjusted amount becomes the final pay for that day',
  '工资日期': 'Pay Date',
  '自动工资': 'Auto Pay',
  '薪资调整': 'Pay Adjustment',
  '调整差额': 'Adjustment',
  '最终工资': 'Final Pay',
  '调整后工资（元）': 'Adjusted Pay (CNY)',
  '调整原因': 'Reason for Adjustment',
  '请填写调整原因': 'Please enter a reason',
  '请输入正确的调整后工资': 'Enter a valid adjusted pay amount',
  '该员工当天没有值班记录，不能调整工资': 'This employee has no duty record for the selected date',
  '例如：临时加班、请假扣减、特殊奖励': 'E.g. overtime, leave deduction, special reward',
  '当前人工调整明细': 'Current Manual Adjustment',
  '人工调整明细': 'Manual Adjustment Details',
  '已调整': 'Adjusted',
  '操作人': 'Adjusted by',
  '原因': 'Reason',
  '恢复自动计算': 'Restore Auto Calculation',
  '确定恢复为系统自动计算的当日工资吗？': 'Restore the system-calculated pay for this day?',
  '已恢复系统自动计算': 'Auto calculation restored',
  '当日工资已调整并生效': 'Daily pay adjustment is now active',
  '确认调整': 'Confirm Adjustment',
  '更新调整': 'Update Adjustment',
  '自动 ¥{auto} → 最终 ¥{final}（差额 {difference}）': 'Auto ¥{auto} → Final ¥{final} ({difference})',
