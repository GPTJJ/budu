...
function StoreModal({ month, store, onClose }) {
  ...
  return (
    <div data-budu-overlay-root className="budu-overlay-viewport fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div role="dialog" aria-modal="true" aria-label={t('门店经营明细')} className="budu-overlay-panel relative flex max-h-[86dvh] w-full max-w-5xl flex-col overflow-hidden rounded-2xl bg-white shadow-lg">
        {/* 头部 */}
