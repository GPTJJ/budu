...
当前 HEAD：`5abe56d`（V1.17），本地与 GitHub main 同步，腾讯云 /opt/budu 已部署该版本。

今日已完成并上线：
1. **V1.17 日历与工资全面体检**（本轮重点，多轮模拟测试通过）：
...
2. **此前版本累计**：发票开具+OCR、大单奖计入工资、调货/采购提醒扩展、版本更新推送、周末工资修复（V1.13-V1.16）
