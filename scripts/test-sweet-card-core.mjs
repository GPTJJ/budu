...
test('28 management surface includes usage, filtering, presets and complete carrier details', () => { const ui = read('src/components/SweetCardPage.jsx'); const wizard = read('src/components/sweet-card/SweetCardCreateWizard.jsx'); assert.match(ui, /使用记录/); assert.match(wizard, /¥500/); assert.match(wizard, /¥1000/); assert.match(ui, /按批次筛选/); assert.match(ui, /Credential/) })
