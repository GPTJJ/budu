...
assert.match(personnelSource, /loadDailyStoreStaffRange\(period\.periodStart, period\.periodEnd, \{ force: true \}\)/)
assert.match(personnelSource, /loadDailyStoreStaffMonth\(m, \{ force: !\(day \|\| weekStart\) \}\)/)
